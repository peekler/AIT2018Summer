...
public class MainActivityTest {
    ...
    public void shouldSetTheBottomNavigationMenu() {
        ...
        BottomNavigationView bottomNavigationView =
                (BottomNavigationView) shadowOf(activityUnderTest).findViewById(R.id.navigation);
    ...
    public void homeFragmentShouldBeStarted() {
        ...
        assertThat(activityUnderTest.getSupportFragmentManager().getFragments().get(0).getTag(),
                is(HomeFragment.class.getName()));
    }
    ...
    public void shouldSwitchToNotificationsFragment() {
        ...
        assertThat(activityUnderTest.getSupportFragmentManager().getFragments().size(), is(1));
        assertThat(activityUnderTest.getSupportFragmentManager().getFragments().get(0).getTag(),
                is(NotificationsFragment.class.getName()));
    }
